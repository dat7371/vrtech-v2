...
const assetVersion = "20260514-1545";

const componentFiles = [
  "components/shared/header.html",
  "components/landing/hero.html",
  "components/landing/products.html",
  "components/landing/buying-guide.html",
  "components/landing/knowledge.html",
...
<body data-page="landing">
  ...
  ${footer}
  <script src="js/app.min.js?v=${assetVersion}" defer></script>
</body>
</html>
`;

window.PRODUCTS = {
  ...
  s2a: {
    ...
    top_title: "VRTECH Edition | Carlinkit V2 | Carlinkit TBOX S2A V2 2026 | Chip Qualcomm 6115 | Apple CarPlay & Android Auto",
    ...
    assurances: [
      ...
      },
      {
        ...
        desc: "Quản lý bảo hành qua VRTECH Connect, quy trình rõ ràng, dễ đối chiếu khi cần hỗ trợ."
      },
      {
    ...
    reasons: [
      ...
      "Phù hợp nhiều dòng xe và dễ tư vấn bán hàng."
    ],
    performance: [
      "Khởi động ổn định cho nhu cầu hằng ngày.",
      "Đủ mượt với YouTube, Maps, nghe nhạc và tác vụ phổ thông.",
      "Tương thích tốt với nhóm xe dùng Android Box cơ bản."
    ],
    features: [
      "Xem YouTube, Netflix",
      "Google Maps / Vietmap",
    ...
    compare_good: [
      ...
      "Dễ triển khai",
      "Dễ tư vấn",
      "Đủ tính năng thiết yếu"
    ],
    compare_bad: [
      "Không phải bản mạnh nhất",
      "Không thiên về hiệu năng cao",
      "Không nhấn mạnh phần thiết kế ambient"
    ]
  },
  ...
  s2p: {
    ...
    top_title: "VRTECH Edition | Carlinkit V2 | Carlinkit TBOX S2P V2 2026 | Chip Qualcomm 6225 | Apple CarPlay & Android Auto",
    ...
    detail_sections: [
      ...
      {
        title: "8. Ứng dụng VRTECH Connect",
        bullets: [
    ...
    reasons: [
      ...
      "Cân bằng rất tốt giữa giá thành, cấu hình và trải nghiệm thực tế trên xe.",
      "Không cần độ chế phức tạp, giữ zin xe và phù hợp nhiều tệp khách từ phổ thông đến trung cấp."
    ],
    performance: [
      "Chip Qualcomm 6225 cho trải nghiệm mượt với YouTube, Netflix, Maps và các tác vụ phổ biến hằng ngày.",
      "Phản hồi tốt khi chuyển ứng dụng, dẫn đường, nghe nhạc và sử dụng song song nhiều tác vụ cơ bản.",
      "Đủ mạnh cho phần lớn nhu cầu sử dụng thực tế trên xe mà vẫn giữ được độ ổn định cao."
    ],
    features: [
      "Xem YouTube, Netflix và các ứng dụng giải trí trực tiếp trên màn hình xe",
      "Dùng Google Maps, Vietmap và các app dẫn đường phổ biến",
      "Hỗ trợ chia đôi màn hình để vừa giải trí vừa theo dõi dẫn đường",
      "Kết nối Wi-Fi / SIM 4G để luôn có Internet khi sử dụng",
      "Tích hợp VRTECH Nexus để quản lý thiết bị và bảo hành điện tử thuận tiện hơn"
    ],
    compare_good: [
      "Giá / hiệu năng rất cân bằng",
      "Dễ tư vấn và dễ chốt đơn",
      "Ổn định cao cho nhu cầu hằng ngày",
      "Phù hợp đa số dòng xe"
    ],
    compare_bad: [
      "Không phải bản nhấn mạnh thiết kế ambient",
      "Không phải cấu hình mạnh nhất trong hệ V2",
      "Không dành riêng cho nhóm khách chỉ tìm flagship hiệu năng"
    ]
  },
  ...
  plus: {
    ...
    top_title: "VRTECH Edition | Carlinkit V2 | Carlinkit TBOX PLUS V2 2026 | Chip Qualcomm 6125 | Apple CarPlay & Android Auto",
    ...
    spec_sections: [
      ...
      },
      {
        ...
        rows: [
          { label: "Ứng dụng quản lý", value: "VRTECH Connect" },
    ...
    features: [
      ...
      "Tích hợp ứng dụng VRTECH Connect"
    ],
    compare_good: [
      "Chip 6125 ổn định",
      "Thiết kế nhỏ gọn, dễ lắp",
  ...
  ambient: {
    ...
    top_title: "VRTECH Edition | Carlinkit V2 | Carlinkit TBOX AMBIENT V2 2026 | Chip Qualcomm 6225 | Apple CarPlay & Android Auto",
    ...
    detail_sections: [
      ...
      {
        title: "App VRTECH Connect - khác biệt độc quyền",
        paragraphs: [
    ...
    spec_sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { label: "Ưu đãi kèm theo", value: "Tặng 3 tháng VRTECH Pro" }
        ]
      },
      {
    ...
    features: [
      ...
      "Truyền file không dây",
      "Quản lý qua ứng dụng VRTECH Connect"
    ],
    compare_good: [
  ...
  ultra: {
    ...
    top_title: "VRTECH Edition | Carlinkit V2 | Carlinkit TBOX ULTRA MAX V2 2026 | Chip Qualcomm SM6350 | Apple CarPlay & Android Auto",
    ...
    spec_sections: [
      {
        ...
        rows: [
          ...
          { label: "Phân phối", value: "VRTECH Official Việt Nam" },
          { label: "Bảo hành", value: "12 tháng (điện tử qua App VRTECH Connect)" }
        ]
      },
      {
        title: "Bộ vi xử lý (CPU)",
    ...
    reasons: [
      ...
      "Là bản đầu bảng để chốt nhóm khách premium."
    ],
    performance: [
      "Mượt với đa nhiệm nặng và chuyển app liên tục.",
      "Phản hồi nhanh, cảm giác dùng mạnh mẽ hơn.",
      "Tối ưu cho nhóm khách muốn bản tốt nhất."
    ],
    features: [
      "Hiệu năng cao cấp",
      "Đa nhiệm mạnh",
    ...
    compare_good: [
      ...
      "Flagship",
      "Đa nhiệm tốt",
      "Phù hợp khách premium"
    ],
    compare_bad: [
      "Chi phí đầu tư cao hơn",
      "Không phải bản tối ưu giá",
      "Không dành cho khách chỉ cần bản cơ bản"
    ]
  }
};
